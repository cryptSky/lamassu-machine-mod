...
Trader.prototype.phoneCode = function phoneCode (phone, isMT = false) {
  return this.request({
    path: '/phone_code',
    method: 'POST',
    body: {phone, isMT}
...
Trader.prototype.getMTTier = function getMTTier (phone) {
  return this.request({
    path: '/mt_tier?' + qs.stringify({phone}),
    method: 'GET'
  })
    .then(r => r.body)
}

Trader.prototype.sendFundingSource = function sendFundingSource (phone, fundingSource) {
  return this.request({
    path: '/funding_source',
    method: 'POST',
    body: {'phone': phone, 'fundingSource': fundingSource}
  })
    .then(r => r.body)
    .catch(err => {
       throw err
...
Trader.prototype.sendSSN = function sendSSN (phone, ssn) {
  return this.request({
    path: '/ssn',
    method: 'POST',
    body: {'phone': phone, 'ssn': ssn}
  })
    .then(r => r.body)
    .catch(err => {
      throw err
